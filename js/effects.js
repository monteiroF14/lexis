...
export function celebrate() {
  ...
  confetti({ ...defaults, angle: 60, origin: { x: 0, y: 0.7 }, particleCount: 80 });
  confetti({ ...defaults, angle: 120, origin: { x: 1, y: 0.7 }, particleCount: 80 });
}
...
export function showLevelUp(level, title) {
  ...
  overlay.innerHTML = `
    <div class="lexis-levelup-card">
      ...
      <div style="font-size: 1.3rem; opacity: 0.85;">Level ${level} &mdash; ${title}</div>
    </div>`;
